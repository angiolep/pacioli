...
class DataFixture {
  ...
  invoice1.addLineItem(new LineItem(descr1 + "#24" + descr2 + "16-Jun", 5, unitPrice1, standardVatRate))
  invoice1.addLineItem(new LineItem(descr1 + "#25" + descr2 + "23-Jun", 5, unitPrice1, standardVatRate))
  invoice1.addLineItem(new LineItem(descr1 + "#26" + descr2 + "30-Jun", 5, unitPrice1, standardVatRate))
  invoice1.addLineItem(new LineItem(descr1 + "#27" + descr2 + "04-Jun", 5, unitPrice1, standardVatRate))
